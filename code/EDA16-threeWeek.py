...
test_head.to_csv('../output/EDA16-threeWeek.csv',index=False)


threeOld = test_head[test_head['pred_prob'] >= 0.595][['user_id', 'cate', 'shop_id']]
threeOld.to_csv('../output/res_threeWeekOld595.csv', index=False)
