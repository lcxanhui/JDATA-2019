...
label_flag = 2
train_buy = jdata_data[(jdata_data['action_time']>='2018-04-02')
                       & (jdata_data['action_time']<'2018-04-09')
...
train_set = jdata_data[(jdata_data['action_time']>='2018-03-05')
                       & (jdata_data['action_time']<'2018-04-02')][['user_id','cate','shop_id']].drop_duplicates()
