...
test_set = jdata_data[(jdata_data['action_time']>='2018-03-19') \
...
test_head.to_csv('../output/EDA16-fourWeek_rightTime.csv',index=False)


fourNew = test_head[test_head['pred_prob'] >= 0.675][['user_id', 'cate', 'shop_id']]
fourNew.to_csv('../output/res_fourWeekNew675.csv', index=False)
