...
win_size = 2#如果选择两周行为则为2 三周则为3
train_set = jdata_data[(jdata_data['action_time']>='2018-03-12')
...
test_set = jdata_data[(jdata_data['action_time'] >= '2018-04-02') & (jdata_data['action_time'] < '2018-04-16')][
