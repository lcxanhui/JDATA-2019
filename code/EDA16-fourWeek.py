...
test_head.to_csv('../output/EDA16-fourWeek.csv',index=False)


fourOld = test_head[test_head['pred_prob'] >= 0.60][['user_id', 'cate', 'shop_id']]
fourOld.to_csv('../output/res_fourWeekOld60.csv', index=False)
